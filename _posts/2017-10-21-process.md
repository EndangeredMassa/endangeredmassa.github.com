...
- I think you could present the structure of the post up front (I'm going to do X, then Y, then Z)
- The feedback section reads like all feedback is corrective. But are there situations where expectations were met, but there are things that could be even better?
- Would love some reasoning for the frequency of the checkins. Every three weeks would be pretty often in most orgs, I believe.
- I don't quite get the structure of section 2. It's a lot of stuff, and I get the labeling of formative processes, but I'm not really clear how it's all formative.
- Under performance review meeting, you say you should determine if something is specific, actionable, etc. Shouldn't that already be done before that? Do you want employees getting unactionable feedback?
- "Those who recently joined or those who are not meeting their expectations may not receive this adjustment." FYI, not giving someone an annual increase will send most people, especially those in demand, looking for another job. If that's an acceptable outcome for under-performers, OK, but if you really think they can still improve, that's a dangerous statement.
...
- spotify organization: http://blog.crisp.se/wp-content/uploads/2012/11/SpotifyScaling.pdf
- talk about how to start adopting these things
- add examples


recruiting auditions: https://medium.com/@trek/tired-engineering-interviews-hired-engineering-auditions-5f9f00147a57
...
The goal here is to provide structures that are fair. We accomplish this through systems of feedback that remove as much influence from bias as possible. Process should Sufficient, Liberating, and Simple.

**Sufficient:** Process should always be just as much as you need, no more. When you identify some process that's not working for you, by all means change or remove it!

**Liberating:** Process should free you from the responsibility of making the numerous small, consistent decisions of day-to-day and week-to-week work. It can relieve [Decision Fatigue](https://en.wikipedia.org/wiki/Decision_fatigue), leaving time and energy to focus on what matters most. Process is a great way to make default decisions.
...
What follows is a series of processes that fit together well, but you should fee free to pick and choose the processes that solve a problem you have and meet your needs. Beyond these suggested processes, companies will have other processes specific to them. These should also try to have built-in systems of feedback.


### Levels of Organizational Maturity

As your organization matures, it will need increasing levels of process. Those leves are: Essential, Formative, and Collaborative. 

**Essential Process:** All (software) companies of all sizes should be following these processes.

**Formative Process:** Most (software) companies of an established form should have a process that addresses the same problems, but they don't necessarily have to be in this form. "Established form" here means that you are larger than a handful of people and have at least a clear medium-term product goal.

**Collaborative Process** Most (software) companies of a more established form should also apply their formative processes to their recruitment efforts.


Startup is a term thrown on all kinds of companies, big and small, old and new, funded and not. I define a startup as a small (less then 30 people), new (less than 4 years old) company that is under threat of nonexistance by running out of money.

A company moves on to a "small business" typically after finding a good product-market fit and scaling up.
...
## Series: Essential, Formative, and Collaborative Process
...
| Tier    | Essential                 | Formative                  | Collaborative                    |
|---------|---------------------------|----------------------------|----------------------------------|
| Product | Code Review               | Code Review                | Code Review                      |
|         | Infrastructure Monitoring | Quality Monitoring         | Performance Monitoring           |
|         | Kanban + Standups         | Kanban + Projects          | Kanban + Projects                |
| Team    | Retrospective             | Scientific Retrospective   | Scientific Retrospective         |
|         | Network Recruiting        | Structured Recruiting      | Elaborate Recruiting             |
|         |                           | Dynamic Reteaming          | Domain-bounded Dynamic Reteaming |
|         |                           | Internship                 | Apprenticeship                   |
| Member  | 1:1 Check-in              | 1:1 Check-in               | 1:1 Check-in                     |
...
These are the essential processes that all companies need to be successful. They are based on an agile premise of tight feedback loops providing better outcomes. It's unreasonable to expect something to improve without strong feedback loops.

The most effective teams are those that have systems of feedback generating continuous improvement of the team, its members, and its code. The essential processes for providing those systems of feedback are retrospectives, 1:1 Check-ins, and Code Review.
...
Use a whiteboard, sticky notes, trello, or whatever works for you to capure what the team is saying. Document the result of this exercise for future reference.

### Schedule

The frequency of retrospectives will vary based on team need.

Weekly

- if team is new to retros
- if team is going through changes

Bi-weekly

- if team is in a stable cadence of delivery
- weekly retros provided too little value

Retrospective schedules longer than every two weeks are a flag that you may not be getting the most out of your retrospectives. Try changing something about how they are run.
...
- use scorecard assessments
  - share the scorecards with the candidate
  - allow candidate to provide more data for a section
...
A Team Member Coach is responsible for:
- Team cohesion
