...
I think we can do better. I know many are trying, too! My intent is not to set up a straw man, but rather share my take on doing better.
...
The other goals:
- be as accurate as possible within the time constraints
...
Jessie is applying for this Software Engineer job:
...
<div class="content">
  ...
  We work in the recruiting software landscape, which is complex and crowded. We're doing something unique in the space by offering the ability to chat with a recruiter before applying to a job, which is exciting, but we're not stopping there.<br>
  <br>
  ...
  <br>
  <strong>Worked on Web Software:</strong> You should have previous experience builing web applications or the systems supporting them. Experience with our entire stack is not necessary. It is helpful to have some experience with at least one of these:<br>
  <ul>
    <li>Node.js (API)</li>
  ...
  <br>
  <strong>Receive Feedback:</strong> You should respond well to valid feedback. Responding well can mean many things, including respectful disagreement. We want to build a strong, trust- and respect-based relationship across the team that allows us to give feedback about actions, not judgements about people.<br>
  <br>
