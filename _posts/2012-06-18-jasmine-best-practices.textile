...
If you continue to do this, you start to see exactly where your functions' dependencies lie. If you argument list is growing too large, it's not because you decided to eliminate global state, it's because your function has too many dependencies. This refactoring simply exposed that problem to you.
...
Only certain functions are async: setTimeout, event triggers (except lib shortcuts), and ajax calls.
